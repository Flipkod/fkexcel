...
/**
 * FKExcel_Writer_Excel5_BIFFwriter
 *
 * @category   FKExcel
 * @package    FKExcel_Writer_Excel5
 * @copyright  Copyright (c) 2006 - 2013 FKExcel (http://www.codeplex.com/FKExcel)
 */
class FKExcel_Writer_Excel5_BIFFwriter
{
	/**
	...
	public static function getByteOrder()
	{
		if (!isset(self::$_byte_order)) {
			...
			if ($number == $teststr) {
				...
				throw new FKExcel_Writer_Exception("Required floating point format not supported on this platform.");
			}

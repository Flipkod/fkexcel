...
/**
 * FKExcel_Writer_Excel2007_Theme
 *
 * @category   FKExcel
 * @package    FKExcel_Writer_Excel2007
 * @copyright  Copyright (c) 2006 - 2013 FKExcel (http://www.codeplex.com/FKExcel)
 */
class FKExcel_Writer_Excel2007_Theme extends FKExcel_Writer_Excel2007_WriterPart
{
	/**
	 ...
	 */
	public function writeTheme(FKExcel $pFKExcel = null)
	{
			// Create XML writer
			$objWriter = null;
	 ...
	 *
	 * @param 	FKExcel_Shared_XMLWriter	$objWriter

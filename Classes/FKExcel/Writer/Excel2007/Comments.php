...
/**
 * FKExcel_Writer_Excel2007_Comments
 *
 * @category   FKExcel
 * @package    FKExcel_Writer_Excel2007
 * @copyright  Copyright (c) 2006 - 2013 FKExcel (http://www.codeplex.com/FKExcel)
 */
class FKExcel_Writer_Excel2007_Comments extends FKExcel_Writer_Excel2007_WriterPart
{
	/**
	 ...
	 */
	public function writeComments(FKExcel_Worksheet $pWorksheet = null)
	{
		// Create XML writer
		$objWriter = null;
	 ...
	 * @param 	FKExcel_Comment				$pComment			Comment
	 * @param	array							$pAuthors			Array of authors
	 * @throws 	FKExcel_Writer_Exception
	 */
	public function _writeComment(FKExcel_Shared_XMLWriter $objWriter = null, $pCellReference = 'A1', FKExcel_Comment $pComment = null, $pAuthors = null)
	{
		// comment
	 ...
	 * @throws 	FKExcel_Writer_Exception
	 */
	public function writeVMLComments(FKExcel_Worksheet $pWorksheet = null)
	{
		// Create XML writer
		$objWriter = null;
		if ($this->getParentWriter()->getUseDiskCaching()) {
	 ...
	 * @throws 	FKExcel_Writer_Exception
	 */
	public function _writeVMLComment(FKExcel_Shared_XMLWriter $objWriter = null, $pCellReference = 'A1', FKExcel_Comment $pComment = null)
	{
 		// Metadata
 		list($column, $row) = FKExcel_Cell::coordinateFromString($pCellReference);
 		$column = FKExcel_Cell::columnIndexFromString($column);
 		$id = 1024 + $column + $row;
 		$id = substr($id, 0, 4);

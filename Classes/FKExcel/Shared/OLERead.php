...
class FKExcel_Shared_OLERead {
	...
	public function read($sFileName)
	{
		...
		if(!is_readable($sFileName)) {
			throw new FKExcel_Reader_Exception("Could not open " . $sFileName . " for reading! File does not exist, or it is not readable.");
		}
		...
		if ($this->data != self::IDENTIFIER_OLE) {
			throw new FKExcel_Reader_Exception('The filename ' . $sFileName . ' is not recognised as an OLE file');
		}

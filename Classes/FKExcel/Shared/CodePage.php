...
/**
 * FKExcel_Shared_CodePage
 *
 * @category   FKExcel
 * @package    FKExcel_Shared
 * @copyright  Copyright (c) 2006 - 2013 FKExcel (http://www.codeplex.com/FKExcel)
 */
class FKExcel_Shared_CodePage
{
	/**
	...
	public static function NumberToName($codePage = 1252)
	{
		switch ($codePage) {
			...
			case 720:	throw new FKExcel_Exception('Code page 720 not supported.');
													break;	//	OEM Arabic
			...
			case 32769:	throw new FKExcel_Exception('Code page 32769 not supported.');
													break;	//	ANSI Latin I (BIFF2-BIFF3)
			case 65000:	return 'UTF-7';				break;	//	Unicode (UTF-7)
			case 65001:	return 'UTF-8';				break;	//	Unicode (UTF-8)
		}

		throw new FKExcel_Exception('Unknown codepage: ' . $codePage);
	}

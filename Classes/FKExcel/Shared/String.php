...
/**
 * FKExcel_Shared_String
 *
 * @category   FKExcel
 * @package    FKExcel_Shared
 * @copyright  Copyright (c) 2006 - 2013 FKExcel (http://www.codeplex.com/FKExcel)
 */
class FKExcel_Shared_String
{
	/**	Constants				*/
	/**	Regular Expressions		*/
	//	Fraction
	...
	public static function convertToNumberIfFraction(&$operand) {
		if (preg_match('/^'.self::STRING_REGEXP_FRACTION.'$/i', $operand, $match)) {
			...
			$operand = FKExcel_Calculation::getInstance()->_calculateFormulaValue($fractionFormula);
			return true;
		}
		return false;
	...
	/**
	 * Set the decimal separator. Only used by FKExcel_Style_NumberFormat::toFormattedString()
	 * to format output by FKExcel_Writer_HTML and FKExcel_Writer_PDF
	 *
	...
	/**
	 * Set the thousands separator. Only used by FKExcel_Style_NumberFormat::toFormattedString()
	 * to format output by FKExcel_Writer_HTML and FKExcel_Writer_PDF
	 *
	...
	/**
	 * Set the currency code. Only used by FKExcel_Style_NumberFormat::toFormattedString()
	 *		to format output by FKExcel_Writer_HTML and FKExcel_Writer_PDF
	 *

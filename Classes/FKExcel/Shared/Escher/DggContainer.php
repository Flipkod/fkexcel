...
/**
 * FKExcel_Shared_Escher_DggContainer
 *
 * @category   FKExcel
 * @package    FKExcel_Shared_Escher
 * @copyright  Copyright (c) 2006 - 2013 FKExcel (http://www.codeplex.com/FKExcel)
 */
class FKExcel_Shared_Escher_DggContainer
{
	/**
	 ...
	 *
	 * @return FKExcel_Shared_Escher_DggContainer_BstoreContainer
	 */
	 ...
	 *
	 * @param FKExcel_Shared_Escher_DggContainer_BstoreContainer $bstoreContainer
	 */

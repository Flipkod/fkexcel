...
/**
 * FKExcel_Style_Alignment
 *
 * @category   FKExcel
 * @package	FKExcel_Style
 * @copyright  Copyright (c) 2006 - 2013 FKExcel (http://www.codeplex.com/FKExcel)
 */
class FKExcel_Style_Alignment extends FKExcel_Style_Supervisor implements FKExcel_IComparable
{
	 ...
	 * @var string
	 */
	protected $_horizontal	= FKExcel_Style_Alignment::HORIZONTAL_GENERAL;
	 ...
	 * @var string
	 */
	protected $_vertical		= FKExcel_Style_Alignment::VERTICAL_BOTTOM;
	...
	/**
	 * Create a new FKExcel_Style_Alignment
	 *
	 ...
	 *
	 * <code>
	 * $objFKExcel->getActiveSheet()->getStyle('B2')->getAlignment()->applyFromArray(
	 *		array(
	 *			'horizontal' => FKExcel_Style_Alignment::HORIZONTAL_CENTER,
	 *			'vertical'   => FKExcel_Style_Alignment::VERTICAL_CENTER,
	 *			'rotation'   => 0,
	 *			'wrap'			=> TRUE
	 *		)
	 * );
	 ...
	 * @return FKExcel_Style_Alignment
	 */
	public function setHorizontal($pValue = FKExcel_Style_Alignment::HORIZONTAL_GENERAL) {
		if ($pValue == '') {
			$pValue = FKExcel_Style_Alignment::HORIZONTAL_GENERAL;
		}
	 ...
	 * @return FKExcel_Style_Alignment
	 */
	public function setVertical($pValue = FKExcel_Style_Alignment::VERTICAL_BOTTOM) {
		if ($pValue == '') {
			$pValue = FKExcel_Style_Alignment::VERTICAL_BOTTOM;
		}
	...
	public function setTextRotation($pValue = 0) {
		// Excel2007 value 255 => FKExcel value -165
		if ($pValue == 255) {
			$pValue = -165;
		}
		...
		if ( ($pValue >= -90 && $pValue <= 90) || $pValue == -165 ) {
			...
			throw new FKExcel_Exception("Text rotation should be a value between -90 and 90.");
		}

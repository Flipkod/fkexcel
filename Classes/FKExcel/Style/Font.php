 ...
 * @copyright  Copyright (c) 2006 - 2013 FKExcel (http://www.codeplex.com/FKExcel)
 */
class FKExcel_Style_Font extends FKExcel_Style_Supervisor implements FKExcel_IComparable
{
	/* Underline types */
	...
	/**
	 * Create a new FKExcel_Style_Font
	 *
	...
	public function __construct($isSupervisor = FALSE, $isConditional = FALSE)
	{
		...
		if ($isConditional) {
			...
			$this->_color			= new FKExcel_Style_Color(FKExcel_Style_Color::COLOR_BLACK, $isSupervisor, $isConditional);
		} else {
	 ...
	 *
	 * <code>
	 * $objFKExcel->getActiveSheet()->getStyle('B2')->getFont()->applyFromArray(
	 *		array(
	 *			'name'		=> 'Arial',
	 *			'bold'		=> TRUE,
	 *			'italic'	=> FALSE,
	 ...
	 * Set Underline
	 *
	 * @param string|boolean $pValue	FKExcel_Style_Font underline type

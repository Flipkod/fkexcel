...
/**
 * FKExcel_CachedObjectStorage_SQLite
 *
 * @category   FKExcel
 * @package    FKExcel_CachedObjectStorage
 * @copyright  Copyright (c) 2006 - 2013 FKExcel (http://www.codeplex.com/FKExcel)
 */
class FKExcel_CachedObjectStorage_SQLite extends FKExcel_CachedObjectStorage_CacheBase implements FKExcel_CachedObjectStorage_ICache {
	...
	protected function _storeData() {
		if ($this->_currentCellIsDirty) {
			...
			if (!$this->_DBHandle->queryExec("INSERT OR REPLACE INTO kvp_".$this->_TableName." VALUES('".$this->_currentObjectID."','".sqlite_escape_string(serialize($this->_currentObject))."')"))
				throw new FKExcel_Exception(sqlite_error_string($this->_DBHandle->lastError()));
	...
	public function moveCell($fromAddress, $toAddress) {
		...
		if ($result === false)
			throw new FKExcel_Exception($this->_DBHandle->lastErrorMsg());

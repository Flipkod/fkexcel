...
/**
 * FKExcel_Worksheet_AutoFilter_Column
 *
 * @category	FKExcel
 * @package		FKExcel_Worksheet
 * @copyright	Copyright (c) 2006 - 2013 FKExcel (http://www.codeplex.com/FKExcel)
 */
class FKExcel_Worksheet_AutoFilter_Column
{
	 ...
	 *
	 * @var array of FKExcel_Worksheet_AutoFilter_Column_Rule
	 */
	...
	/**
	 * Create a new FKExcel_Worksheet_AutoFilter_Column
	 *
	 *	@param	string		                   $pColumn		Column (e.g. A)
	 *	@param	FKExcel_Worksheet_AutoFilter  $pParent		Autofilter for this column
	 */
	public function __construct($pColumn, FKExcel_Worksheet_AutoFilter $pParent = NULL)
	{
	 ...
	 *
	 * @param FKExcel_Worksheet_AutoFilter
	 * @return FKExcel_Worksheet_AutoFilter_Column
	 */
	public function setParent(FKExcel_Worksheet_AutoFilter $pParent = NULL) {
		$this->_parent = $pParent;
	...
	public function setFilterType($pFilterType = self::AUTOFILTER_FILTERTYPE_FILTER) {
		if (!in_array($pFilterType,self::$_filterTypes)) {
			throw new FKExcel_Exception('Invalid filter type for column AutoFilter.');
		}
	...
	public function setJoin($pJoin = self::AUTOFILTER_COLUMN_JOIN_OR) {
		...
		if (!in_array($pJoin,self::$_ruleJoins)) {
			throw new FKExcel_Exception('Invalid rule connection for column AutoFilter.');
		}
	 ...
	 *
	 * @throws	FKExcel_Exception
	 * @return array of FKExcel_Worksheet_AutoFilter_Column_Rule
	 */
	 ...
	 * @return	FKExcel_Worksheet_AutoFilter_Column_Rule
	 */
	public function getRule($pIndex) {
		if (!isset($this->_ruleset[$pIndex])) {
			$this->_ruleset[$pIndex] = new FKExcel_Worksheet_AutoFilter_Column_Rule($this);
		}
	...
	public function createRule() {
		$this->_ruleset[] = new FKExcel_Worksheet_AutoFilter_Column_Rule($this);
	 ...
	 *
	 * @param	FKExcel_Worksheet_AutoFilter_Column_Rule	$pRule
	 * @param	boolean	$returnRule 	Flag indicating whether the rule object or the column object should be returned
	 * @return	FKExcel_Worksheet_AutoFilter_Column|FKExcel_Worksheet_AutoFilter_Column_Rule
	 */
	public function addRule(FKExcel_Worksheet_AutoFilter_Column_Rule $pRule, $returnRule=TRUE) {

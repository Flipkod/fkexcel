...
/**
 * FKExcel_Worksheet_HeaderFooter
 *
 * <code>
 ...
 * @copyright  Copyright (c) 2006 - 2013 FKExcel (http://www.codeplex.com/FKExcel)
 */
class FKExcel_Worksheet_HeaderFooter
{
	 ...
	 *
	 * @var FKExcel_Worksheet_HeaderFooterDrawing[]
	 */
	private $_headerFooterImages = array();

    /**
     * Create a new FKExcel_Worksheet_HeaderFooter
     */
     ...
     *
     * @param FKExcel_Worksheet_HeaderFooterDrawing $image
     * @param string $location
     * @throws FKExcel_Exception
     * @return FKExcel_Worksheet_HeaderFooter
     */
    public function addImage(FKExcel_Worksheet_HeaderFooterDrawing $image = null, $location = self::IMAGE_HEADER_LEFT) {
     ...
     *
     * @param FKExcel_Worksheet_HeaderFooterDrawing[] $images
     * @throws FKExcel_Exception
     * @return FKExcel_Worksheet_HeaderFooter
     */
    public function setImages($images) {
    	if (!is_array($images)) {
    		throw new FKExcel_Exception('Invalid parameter!');
    	}
     ...
     *
     * @return FKExcel_Worksheet_HeaderFooterDrawing[]
     */

...
/**
 * FKExcel_Worksheet_CellIterator
 *
 ...
 * @copyright  Copyright (c) 2006 - 2013 FKExcel (http://www.codeplex.com/FKExcel)
 */
class FKExcel_Worksheet_CellIterator implements Iterator
{
	/**
	 ...
	 *
	 * @param FKExcel_Worksheet 		$subject
	 * @param int						$rowIndex
	 */
	public function __construct(FKExcel_Worksheet $subject = null, $rowIndex = 1) {
    ...
    /**
     * Are there any more FKExcel_Cell instances available?
     *
     * @return boolean
     */
    public function valid() {
        ...
        // position.
        $columnCount = FKExcel_Cell::columnIndexFromString($this->_subject->getHighestColumn());

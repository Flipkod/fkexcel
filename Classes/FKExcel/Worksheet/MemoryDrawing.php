...
/**
 * FKExcel_Worksheet_MemoryDrawing
 *
 * @category   FKExcel
 * @package    FKExcel_Worksheet
 * @copyright  Copyright (c) 2006 - 2013 FKExcel (http://www.codeplex.com/FKExcel)
 */
class FKExcel_Worksheet_MemoryDrawing extends FKExcel_Worksheet_BaseDrawing implements FKExcel_IComparable
{
	/* Rendering functions */
    ...
    /**
     * Create a new FKExcel_Worksheet_MemoryDrawing
     */
     ...
     * @return FKExcel_Worksheet_MemoryDrawing
     */
     ...
     * @return FKExcel_Worksheet_MemoryDrawing
     */
    public function setRenderingFunction($value = FKExcel_Worksheet_MemoryDrawing::RENDERING_DEFAULT) {
     ...
     * @return FKExcel_Worksheet_MemoryDrawing
     */
    public function setMimeType($value = FKExcel_Worksheet_MemoryDrawing::MIMETYPE_DEFAULT) {

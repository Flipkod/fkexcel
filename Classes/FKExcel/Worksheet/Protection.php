...
/**
 * FKExcel_Worksheet_Protection
 *
 * @category   FKExcel
 * @package    FKExcel_Worksheet
 * @copyright  Copyright (c) 2006 - 2013 FKExcel (http://www.codeplex.com/FKExcel)
 */
class FKExcel_Worksheet_Protection
{
	/**
	 * Sheet
	 *
    ...
    /**
     * Create a new FKExcel_Worksheet_Protection
     */
    ...
    function setPassword($pValue = '', $pAlreadyHashed = false) {
    	if (!$pAlreadyHashed) {
    		$pValue = FKExcel_Shared_PasswordHasher::hashPassword($pValue);
    	}

...
/**
 * FKExcel_Worksheet_SheetView
 *
 * @category   FKExcel
 * @package    FKExcel_Worksheet
 * @copyright  Copyright (c) 2006 - 2013 FKExcel (http://www.codeplex.com/FKExcel)
 */
class FKExcel_Worksheet_SheetView
{
    ...
    /**
     * Create a new FKExcel_Worksheet_SheetView
     */
	...
	public function setZoomScale($pValue = 100) {
		...
		if (($pValue >= 1) || is_null($pValue)) {
			...
			throw new FKExcel_Exception("Scale must be greater than or equal to 1.");
		}
		return $this;
	}
	...
	public function setView($pValue = NULL) {
		...
		if (in_array($pValue, self::$_sheetViewTypes)) {
			...
			throw new FKExcel_Exception("Invalid sheetview layout type.");
		}

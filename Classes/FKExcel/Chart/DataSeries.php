...
/**
 * FKExcel_Chart_DataSeries
 *
 * @category	FKExcel
 * @package		FKExcel_Chart
 * @copyright	Copyright (c) 2006 - 2013 FKExcel (http://www.codeplex.com/FKExcel)
 */
class FKExcel_Chart_DataSeries
{
	 ...
	 * Plot Label
	 *
	 * @var array of FKExcel_Chart_DataSeriesValues
	 */
	...
	/**
	 * Create a new FKExcel_Chart_DataSeries
	 */
	public function __construct($plotType = null, $plotGrouping = null, $plotOrder = array(), $plotLabel = array(), $plotCategory = array(), $plotValues = array(), $smoothLine = null, $plotStyle = null)
	{
		...
		if ((count($plotLabel) == 0) || (is_null($plotLabel[$keys[0]]))) {
			$plotLabel[$keys[0]] = new FKExcel_Chart_DataSeriesValues();
		}

		$this->_plotLabel = $plotLabel;
		if ((count($plotCategory) == 0) || (is_null($plotCategory[$keys[0]]))) {
			$plotCategory[$keys[0]] = new FKExcel_Chart_DataSeriesValues();
		}
	 ...
	 * Get Plot Labels
	 *
	 * @return array of FKExcel_Chart_DataSeriesValues
	 */

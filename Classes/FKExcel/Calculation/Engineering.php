...
/**
 * FKExcel_Calculation_Engineering
 *
 * @category	FKExcel
 * @package		FKExcel_Calculation
 * @copyright	Copyright (c) 2006 - 2013 FKExcel (http://www.codeplex.com/FKExcel)
 */
class FKExcel_Calculation_Engineering {
	...
	public static function BESSELI($x, $ord) {
		$x	= (is_null($x))	? 0.0 :	FKExcel_Calculation_Functions::flattenSingleValue($x);
		$ord	= (is_null($ord))	? 0.0 :	FKExcel_Calculation_Functions::flattenSingleValue($ord);
		...
		if ((is_numeric($x)) && (is_numeric($ord))) {
			...
			if (abs($x) <= 30) {
				$fResult = $fTerm = pow($x / 2, $ord) / FKExcel_Calculation_MathTrig::FACT($ord);
				$ordK = 1;
				$fSqrX = ($x * $x) / 4;
				do {
					$fTerm *= $fSqrX;
			...
			return (is_nan($fResult)) ? FKExcel_Calculation_Functions::NaN() : $fResult;
		}
	...
	public static function BESSELK($x, $ord) {
		...
		if ((is_numeric($x)) && (is_numeric($ord))) {
			...
			return (is_nan($fBk)) ? FKExcel_Calculation_Functions::NaN() : $fBk;
		}
		return FKExcel_Calculation_Functions::VALUE();
	}	//	function BESSELK()
	...
	public static function BESSELY($x, $ord) {
		...
		if ((is_numeric($x)) && (is_numeric($ord))) {
			...
			return (is_nan($fBy)) ? FKExcel_Calculation_Functions::NaN() : $fBy;
		}
		return FKExcel_Calculation_Functions::VALUE();
	}	//	function BESSELY()
	...
	public static function BINTOHEX($x, $places=NULL) {
		$x	= FKExcel_Calculation_Functions::flattenSingleValue($x);
		$places	= FKExcel_Calculation_Functions::flattenSingleValue($places);
	...
	public static function COMPLEX($realNumber=0.0, $imaginary=0.0, $suffix='i') {
		$realNumber	= (is_null($realNumber))	? 0.0 :	FKExcel_Calculation_Functions::flattenSingleValue($realNumber);
		$imaginary	= (is_null($imaginary))		? 0.0 :	FKExcel_Calculation_Functions::flattenSingleValue($imaginary);
		$suffix		= (is_null($suffix))		? 'i' :	FKExcel_Calculation_Functions::flattenSingleValue($suffix);
	...
	public static function IMAGINARY($complexNumber) {
		$complexNumber	= FKExcel_Calculation_Functions::flattenSingleValue($complexNumber);
	...
	public static function IMPOWER($complexNumber,$realNumber) {
		$complexNumber	= FKExcel_Calculation_Functions::flattenSingleValue($complexNumber);
		$realNumber		= FKExcel_Calculation_Functions::flattenSingleValue($realNumber);
	...
	public static function IMDIV($complexDividend,$complexDivisor) {
		$complexDividend	= FKExcel_Calculation_Functions::flattenSingleValue($complexDividend);
		$complexDivisor	= FKExcel_Calculation_Functions::flattenSingleValue($complexDivisor);
	...
	public static function IMSUB($complexNumber1,$complexNumber2) {
		$complexNumber1	= FKExcel_Calculation_Functions::flattenSingleValue($complexNumber1);
		$complexNumber2	= FKExcel_Calculation_Functions::flattenSingleValue($complexNumber2);
	...
	public static function GESTEP($number, $step=0) {
		...
		$step	= FKExcel_Calculation_Functions::flattenSingleValue($step);
	 ...
	 *			FKExcel follows Excel 2010 behaviour, and accepts nagative arguments.
	 *
	 *	Excel Function:
	 *		ERF(lower[,upper])
	 *
	...
	public static function ERF($lower, $upper = NULL) {
		$lower	= FKExcel_Calculation_Functions::flattenSingleValue($lower);
		$upper	= FKExcel_Calculation_Functions::flattenSingleValue($upper);
	...
	public static function CONVERTUOM($value, $fromUOM, $toUOM) {
		...
		$fromUOM	= FKExcel_Calculation_Functions::flattenSingleValue($fromUOM);
		$toUOM		= FKExcel_Calculation_Functions::flattenSingleValue($toUOM);

...
/**
 * FKExcel_Worksheet_ColumnDimension
 *
 * @category   FKExcel
 * @package    FKExcel_Worksheet
 * @copyright  Copyright (c) 2006 - 2013 FKExcel (http://www.codeplex.com/FKExcel)
 */
class FKExcel_Worksheet_ColumnDimension
{
	/**
	 * Column index
	 *
    ...
    /**
     * Create a new FKExcel_Worksheet_ColumnDimension
     *
    ...
    public function setOutlineLevel($pValue) {
    	if ($pValue < 0 || $pValue > 7) {
    		throw new FKExcel_Exception("Outline level must range between 0 and 7.");
    	}

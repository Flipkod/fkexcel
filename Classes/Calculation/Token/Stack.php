...
/**
 * FKExcel_Calculation_Token_Stack
 *
 * @category	FKExcel_Calculation_Token_Stack
 * @package		FKExcel_Calculation
 * @copyright	Copyright (c) 2006 - 2013 FKExcel (http://www.codeplex.com/FKExcel)
 */
class FKExcel_Calculation_Token_Stack {
	...
	public function push($type, $value, $reference = NULL) {
		...
		if ($type == 'Function') {
			$localeFunction = FKExcel_Calculation::_localeFunc($value);

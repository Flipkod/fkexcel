...
/**
 * FKExcel_CachedObjectStorage_CacheBase
 *
 * @category   FKExcel
 * @package    FKExcel_CachedObjectStorage
 * @copyright  Copyright (c) 2006 - 2013 FKExcel (http://www.codeplex.com/FKExcel)
 */
abstract class FKExcel_CachedObjectStorage_CacheBase {
	 ...
	 */
	public function __construct(FKExcel_Worksheet $parent) {
		//	Set our parent worksheet.
		//	This is maintained within the cache controller to facilitate re-attaching it to FKExcel_Cell objects when
     ...
     */
	public function updateCacheData(FKExcel_Cell $cell) {

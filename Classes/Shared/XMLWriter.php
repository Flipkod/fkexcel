...
/**
 * FKExcel_Shared_XMLWriter
 *
 * @category   FKExcel
 * @package	FKExcel_Shared
 * @copyright  Copyright (c) 2006 - 2013 FKExcel (http://www.codeplex.com/FKExcel)
 */
class FKExcel_Shared_XMLWriter extends XMLWriter {
	...
	/**
	 * Create a new FKExcel_Shared_XMLWriter instance
	 *
	...
	public function __construct($pTemporaryStorage = self::STORAGE_MEMORY, $pTemporaryStorageFolder = NULL) {
		...
		if ($pTemporaryStorage == self::STORAGE_MEMORY) {
			...
			if ($pTemporaryStorageFolder === NULL)
				$pTemporaryStorageFolder = FKExcel_Shared_File::sys_get_temp_dir();

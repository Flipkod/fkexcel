...
require_once FKExcel_ROOT . 'FKExcel/Shared/trend/bestFitClass.php';
require_once FKExcel_ROOT . 'FKExcel/Shared/JAMA/Matrix.php';


/**
 * FKExcel_Polynomial_Best_Fit
 *
 * @category   FKExcel
 * @package    FKExcel_Shared_Trend
 * @copyright  Copyright (c) 2006 - 2013 FKExcel (http://www.codeplex.com/FKExcel)
 */
class FKExcel_Polynomial_Best_Fit extends FKExcel_Best_Fit
{
	/**

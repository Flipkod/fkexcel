 ...
 *
 * @category   FKExcel
 * @package    FKExcel_Shared_ZipArchive
...
if (!defined('PCLZIP_TEMPORARY_DIR')) {
	define('PCLZIP_TEMPORARY_DIR', FKExcel_Shared_File::sys_get_temp_dir());
}
require_once FKExcel_ROOT . 'FKExcel/Shared/PCLZip/pclzip.lib.php';


/**
 * FKExcel_Shared_ZipArchive
 *
 * @category   FKExcel
 * @package    FKExcel_Shared_ZipArchive
 * @copyright  Copyright (c) 2006 - 2013 FKExcel (http://www.codeplex.com/FKExcel)
 */
class FKExcel_Shared_ZipArchive
{
	...
	public function addFromString($localname, $contents)
	{
		...
		if ($res == 0) {
			throw new FKExcel_Writer_Exception("Error zipping files : " . $this->_zip->errorInfo(true));
		}

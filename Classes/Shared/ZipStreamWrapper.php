...
/**
 * FKExcel_Shared_ZipStreamWrapper
 *
 * @category   FKExcel
 * @package    FKExcel_Shared
 * @copyright  Copyright (c) 2006 - 2013 FKExcel (http://www.codeplex.com/FKExcel)
 */
class FKExcel_Shared_ZipStreamWrapper {
	/**
	 * Internal ZipAcrhive
	 *
	 * @var ZipAcrhive
    ...
    public function stream_open($path, $mode, $options, &$opened_path) {
        // Check for mode
        if ($mode{0} != 'r') {
            throw new FKExcel_Reader_Exception('Mode ' . $mode . ' is not supported. Only read mode is supported.');
        }

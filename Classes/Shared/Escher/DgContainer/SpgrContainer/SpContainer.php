...
/**
 * FKExcel_Shared_Escher_DgContainer_SpgrContainer_SpContainer
 *
 * @category   FKExcel
 * @package    FKExcel_Shared_Escher
 * @copyright  Copyright (c) 2006 - 2013 FKExcel (http://www.codeplex.com/FKExcel)
 */
class FKExcel_Shared_Escher_DgContainer_SpgrContainer_SpContainer
{
	/**
	 ...
	 *
	 * @return FKExcel_Shared_Escher_DgContainer_SpgrContainer
	 */
	...
	public function getNestingLevel()
	{
		...
		while ($parent instanceof FKExcel_Shared_Escher_DgContainer_SpgrContainer) {
			++$nestingLevel;

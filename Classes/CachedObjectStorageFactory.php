...
/**
 * FKExcel_CachedObjectStorageFactory
 *
 * @category    FKExcel
 * @package        FKExcel_CachedObjectStorage
 * @copyright    Copyright (c) 2006 - 2013 FKExcel (http://www.codeplex.com/FKExcel)
 */
class FKExcel_CachedObjectStorageFactory
{
     ...
     *
     * @return FKExcel_CachedObjectStorage_ICache|NULL
     **/
    ...
    public static function getCacheStorageMethods()
    {
        ...
        foreach(self::$_storageMethods as $storageMethod) {
            $cacheStorageClass = 'FKExcel_CachedObjectStorage_' . $storageMethod;
    ...
    public static function initialize($method = self::cache_in_memory, $arguments = array())
    {
        ...
        $cacheStorageClass = 'FKExcel_CachedObjectStorage_'.$method;
        ...
        if (self::$_cacheStorageMethod === NULL) {
            self::$_cacheStorageClass = 'FKExcel_CachedObjectStorage_' . $method;
     ...
     *
     * @param    FKExcel_Worksheet     $parent        Enable cell caching for this worksheet
     * @return    FKExcel_CachedObjectStorage_ICache
     **/
    public static function getInstance(FKExcel_Worksheet $parent)
    {

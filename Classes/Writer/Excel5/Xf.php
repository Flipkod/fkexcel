...
/**
 * FKExcel_Writer_Excel5_Xf
 *
 * @category   FKExcel
 * @package    FKExcel_Writer_Excel5
 * @copyright  Copyright (c) 2006 - 2013 FKExcel (http://www.codeplex.com/FKExcel)
 */
class FKExcel_Writer_Excel5_Xf
{
    /**
	...
	*/
	 ...
	 *
	 * @access public
	 * @param FKExcel_Style	The XF format
	 */
	public function __construct(FKExcel_Style $style = null)
	{
	...
	function writeXf()
	{
		...
		$diag_tl_to_rb = $diagonalDirection == FKExcel_Style_Borders::DIAGONAL_BOTH
							|| $diagonalDirection == FKExcel_Style_Borders::DIAGONAL_DOWN;
		$diag_tr_to_lb = $diagonalDirection == FKExcel_Style_Borders::DIAGONAL_BOTH
							|| $diagonalDirection == FKExcel_Style_Borders::DIAGONAL_UP;
	 ...
	 *
	 */
	private static $_mapBorderStyle = array	( FKExcel_Style_Border::BORDER_NONE				=> 0x00,
											  FKExcel_Style_Border::BORDER_THIN				=> 0x01,
											  FKExcel_Style_Border::BORDER_MEDIUM				=> 0x02,
											  FKExcel_Style_Border::BORDER_DASHED				=> 0x03,
											  FKExcel_Style_Border::BORDER_DOTTED				=> 0x04,
											  FKExcel_Style_Border::BORDER_THICK				=> 0x05,
											  FKExcel_Style_Border::BORDER_DOUBLE				=> 0x06,
											  FKExcel_Style_Border::BORDER_HAIR				=> 0x07,
											  FKExcel_Style_Border::BORDER_MEDIUMDASHED		=> 0x08,
											  FKExcel_Style_Border::BORDER_DASHDOT				=> 0x09,
											  FKExcel_Style_Border::BORDER_MEDIUMDASHDOT		=> 0x0A,
											  FKExcel_Style_Border::BORDER_DASHDOTDOT			=> 0x0B,
											  FKExcel_Style_Border::BORDER_MEDIUMDASHDOTDOT	=> 0x0C,
											  FKExcel_Style_Border::BORDER_SLANTDASHDOT		=> 0x0D,
											);
	 ...
	 *
	 */
	private static $_mapFillType = array( FKExcel_Style_Fill::FILL_NONE					=> 0x00,
										  FKExcel_Style_Fill::FILL_SOLID					=> 0x01,
										  FKExcel_Style_Fill::FILL_PATTERN_MEDIUMGRAY		=> 0x02,
										  FKExcel_Style_Fill::FILL_PATTERN_DARKGRAY		=> 0x03,
										  FKExcel_Style_Fill::FILL_PATTERN_LIGHTGRAY		=> 0x04,
										  FKExcel_Style_Fill::FILL_PATTERN_DARKHORIZONTAL	=> 0x05,
										  FKExcel_Style_Fill::FILL_PATTERN_DARKVERTICAL	=> 0x06,
										  FKExcel_Style_Fill::FILL_PATTERN_DARKDOWN		=> 0x07,
										  FKExcel_Style_Fill::FILL_PATTERN_DARKUP			=> 0x08,
										  FKExcel_Style_Fill::FILL_PATTERN_DARKGRID		=> 0x09,
										  FKExcel_Style_Fill::FILL_PATTERN_DARKTRELLIS		=> 0x0A,
										  FKExcel_Style_Fill::FILL_PATTERN_LIGHTHORIZONTAL	=> 0x0B,
										  FKExcel_Style_Fill::FILL_PATTERN_LIGHTVERTICAL	=> 0x0C,
										  FKExcel_Style_Fill::FILL_PATTERN_LIGHTDOWN		=> 0x0D,
										  FKExcel_Style_Fill::FILL_PATTERN_LIGHTUP			=> 0x0E,
										  FKExcel_Style_Fill::FILL_PATTERN_LIGHTGRID		=> 0x0F,
										  FKExcel_Style_Fill::FILL_PATTERN_LIGHTTRELLIS	=> 0x10,
										  FKExcel_Style_Fill::FILL_PATTERN_GRAY125			=> 0x11,
										  FKExcel_Style_Fill::FILL_PATTERN_GRAY0625		=> 0x12,
										  FKExcel_Style_Fill::FILL_GRADIENT_LINEAR			=> 0x00,	// does not exist in BIFF8
										  FKExcel_Style_Fill::FILL_GRADIENT_PATH			=> 0x00,	// does not exist in BIFF8
										);
	/**
	 * Map fill type
	 *
	 ...
	 *
	 */
	private static $_mapHAlign = array( FKExcel_Style_Alignment::HORIZONTAL_GENERAL			=> 0,
										FKExcel_Style_Alignment::HORIZONTAL_LEFT				=> 1,
										FKExcel_Style_Alignment::HORIZONTAL_CENTER				=> 2,
										FKExcel_Style_Alignment::HORIZONTAL_RIGHT				=> 3,
										FKExcel_Style_Alignment::HORIZONTAL_FILL				=> 4,
										FKExcel_Style_Alignment::HORIZONTAL_JUSTIFY			=> 5,
										FKExcel_Style_Alignment::HORIZONTAL_CENTER_CONTINUOUS	=> 6,
									  );
	/**
	 ...
	 *
	 */
	private static $_mapVAlign = array( FKExcel_Style_Alignment::VERTICAL_TOP		=> 0,
										FKExcel_Style_Alignment::VERTICAL_CENTER	=> 1,
										FKExcel_Style_Alignment::VERTICAL_BOTTOM	=> 2,
										FKExcel_Style_Alignment::VERTICAL_JUSTIFY	=> 3,
									  );
	/**
	...
	private static function _mapLocked($locked) {
		switch ($locked) {
			case FKExcel_Style_Protection::PROTECTION_INHERIT:		return 1;
			case FKExcel_Style_Protection::PROTECTION_PROTECTED:	return 1;
			case FKExcel_Style_Protection::PROTECTION_UNPROTECTED:	return 0;
			default:												return 1;
		}
	}
	...
	private static function _mapHidden($hidden) {
		switch ($hidden) {
			case FKExcel_Style_Protection::PROTECTION_INHERIT:		return 0;
			case FKExcel_Style_Protection::PROTECTION_PROTECTED:	return 1;
			case FKExcel_Style_Protection::PROTECTION_UNPROTECTED:	return 0;
			default:												return 0;
		}

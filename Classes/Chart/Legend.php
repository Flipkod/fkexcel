...
/**
 * FKExcel_Chart_Legend
 *
 * @category	FKExcel
 * @package		FKExcel_Chart
 * @copyright	Copyright (c) 2006 - 2013 FKExcel (http://www.codeplex.com/FKExcel)
 */
class FKExcel_Chart_Legend
{
	/** Legend positions */
	...
	/**
	 *	Create a new FKExcel_Chart_Legend
	 */
	public function __construct($position = self::POSITION_RIGHT, FKExcel_Chart_Layout $layout = NULL, $overlay = FALSE)
	{

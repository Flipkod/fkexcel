...
class FKExcel_Chart
{
	...
	/**
	 * Create a new FKExcel_Chart
	 */
	public function __construct($name, FKExcel_Chart_Title $title = null, FKExcel_Chart_Legend $legend = null, FKExcel_Chart_PlotArea $plotArea = null, $plotVisibleOnly = true, $displayBlanksAs = '0', FKExcel_Chart_Title $xAxisLabel = null, FKExcel_Chart_Title $yAxisLabel = null)
	{
		$this->_name = $name;
		$this->_title = $title;
		$this->_legend = $legend;
	 ...
	 * @throws	FKExcel_Chart_Exception
	 * @return FKExcel_Chart
	 */
	public function setWorksheet(FKExcel_Worksheet $pValue = null) {
	 ...
	 * @return	FKExcel_Chart
	 */
	public function setTitle(FKExcel_Chart_Title $title) {
		$this->_title = $title;
	 ...
	 * @return	FKExcel_Chart
	 */
	public function setLegend(FKExcel_Chart_Legend $legend) {
		$this->_legend = $legend;
	 ...
	 * Set X-Axis Label
	 *
	 * @param	FKExcel_Chart_Title $label
	 * @return	FKExcel_Chart
	 */
	public function setXAxisLabel(FKExcel_Chart_Title $label) {
	 ...
	 * @return	FKExcel_Chart
	 */
	public function setYAxisLabel(FKExcel_Chart_Title $label) {
	...
	public function render($outputDestination = null) {
		$libraryName = FKExcel_Settings::getChartRendererName();
		...
		$libraryPath = FKExcel_Settings::getChartRendererPath();
		...
		$rendererName = 'FKExcel_Chart_Renderer_'.$libraryName;

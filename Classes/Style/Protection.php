...
/**
 * FKExcel_Style_Protection
 *
 * @category   FKExcel
 * @package    FKExcel_Style
 * @copyright  Copyright (c) 2006 - 2013 FKExcel (http://www.codeplex.com/FKExcel)
 */
class FKExcel_Style_Protection extends FKExcel_Style_Supervisor implements FKExcel_IComparable
{
	/** Protection styles */
	...
	/**
     * Create a new FKExcel_Style_Protection
	 *
     ...
     *
     * <code>
     * $objFKExcel->getActiveSheet()->getStyle('B2')->getLocked()->applyFromArray(
     *		array(
     *			'locked' => TRUE,
     *			'hidden' => FALSE
     *		)

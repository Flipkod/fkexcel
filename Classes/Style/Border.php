...
/**
 * FKExcel_Style_Border
 *
 * @category   FKExcel
 * @package	FKExcel_Style
 * @copyright  Copyright (c) 2006 - 2013 FKExcel (http://www.codeplex.com/FKExcel)
 */
class FKExcel_Style_Border extends FKExcel_Style_Supervisor implements FKExcel_IComparable
{
	/* Border style */
	 ...
	 * @var string
	 */
	protected $_borderStyle	= FKExcel_Style_Border::BORDER_NONE;
	...
	/**
	 * Create a new FKExcel_Style_Border
	 *
	...
	public function __construct($isSupervisor = FALSE, $isConditional = FALSE)
	{
		...
		// Initialise values
		$this->_color	= new FKExcel_Style_Color(FKExcel_Style_Color::COLOR_BLACK, $isSupervisor);
	 ...
	 *
	 * @param FKExcel_Style_Borders $parent
	...
	public function getSharedComponent()
	{
		switch ($this->_parentPropertyName) {
			...
			case '_outline':
			case '_vertical':
				throw new FKExcel_Exception('Cannot get shared component for a pseudo-border.');
				break;
			case '_bottom':
	 ...
	 *
	 * <code>
	 * $objFKExcel->getActiveSheet()->getStyle('B2')->getBorders()->getTop()->applyFromArray(
	 *		array(
	 ...
	 *							When passing a boolean, FALSE equates FKExcel_Style_Border::BORDER_NONE
	 *								and TRUE to FKExcel_Style_Border::BORDER_MEDIUM
	 * @return FKExcel_Style_Border
	 */
	public function setBorderStyle($pValue = FKExcel_Style_Border::BORDER_NONE) {

		if (empty($pValue)) {
			$pValue = FKExcel_Style_Border::BORDER_NONE;
		} elseif(is_bool($pValue) && $pValue) {
			$pValue = FKExcel_Style_Border::BORDER_MEDIUM;
		}
		if ($this->_isSupervisor) {
	 ...
	 * @return FKExcel_Style_Border
	 */
	public function setColor(FKExcel_Style_Color $pValue = null) {

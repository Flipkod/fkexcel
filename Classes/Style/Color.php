 ...
 * @copyright  Copyright (c) 2006 - 2013 FKExcel (http://www.codeplex.com/FKExcel)
 */
class FKExcel_Style_Color extends FKExcel_Style_Supervisor implements FKExcel_IComparable
{
	/* Colors */
	...
	/**
	 * Create a new FKExcel_Style_Color
	 *
	 ...
	 *										its ramifications are
	 */
	public function __construct($pARGB = FKExcel_Style_Color::COLOR_BLACK, $isSupervisor = FALSE, $isConditional = FALSE)
	{
		//	Supervisor?
	 ...
	 *
	 * <code>
	 * $objFKExcel->getActiveSheet()->getStyle('B2')->getFont()->getColor()->applyFromArray( array('rgb' => '808080') );
	 * </code>
	 *
	 ...
	 * @return FKExcel_Style_Color
	 */
	public function setARGB($pValue = FKExcel_Style_Color::COLOR_BLACK) {
		if ($pValue == '') {
			$pValue = FKExcel_Style_Color::COLOR_BLACK;
		}
		if ($this->_isSupervisor) {
	...
	public static function indexedColor($pIndex, $background=FALSE) {
		...
		if (array_key_exists($pIndex, self::$_indexedColors)) {
			return new FKExcel_Style_Color(self::$_indexedColors[$pIndex]);
		}

		if ($background) {
			return new FKExcel_Style_Color('FFFFFFFF');
		}
		return new FKExcel_Style_Color('FF000000');
	}
